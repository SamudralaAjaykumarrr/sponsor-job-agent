...
from app.applications import human_verified_employment_evidence, post_approval, repo
...
def _record_approval_row(job: Job, execution: dict, *, provider_submission_supported: bool) -> str:
    ...
    employment_type = human_verified_employment_evidence.resolve_for_job(job).value
