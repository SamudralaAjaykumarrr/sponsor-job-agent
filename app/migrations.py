...
def _m051_workday_tenant_dynamic_validation_column(conn, backend: str) -> None:
...
MIGRATIONS: list[tuple[int, str, Callable]] = [
    ...
    (51, "workday_tenant_dynamic_validation_column", _m051_workday_tenant_dynamic_validation_column),
]
